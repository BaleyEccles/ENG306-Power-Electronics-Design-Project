...
\begin{figure}[H]
\centering
\includegraphics[angle=90,width=.9\linewidth]{./IMG20251016100928.jpg}
\caption{Designed Converter Running An Arduino Uno \label{fig:BOARD}}
\end{figure}
\section{Design}
\label{sec:orgad386f3}

\subsection{Specifications}
\label{sec:org45c6d7d}
\begin{table}[H]
...
Voltage ripple & 0.7\%\\
\hline
DC output voltage (\(V\)) & 12\textpm{}0.03\\
\hline
\end{tabular}
\end{table}
\subsection{Calculations And Component Selection}
\label{sec:orgccffa2d}
\subsubsection{Rectifier}
\label{sec:org367e006}
